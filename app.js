...
// Connection URL mongodb is running on same machine at port 27017 
//hence the url is localhost:27017, if mongodb is running on 
//different machine then replace localhost with its ip address
...
app.use('/', routes);
//app.use("/book", bookRouter) /book/add  /book/delete /book/update
//app.use("/author",autherrouter)  /author/add  /author/delete  /book/update
